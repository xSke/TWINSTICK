...
public class Assets {
    ...
    public static Music music = Gdx.audio.newMusic(Gdx.files.internal("audio/loop.ogg"));
    public static Music ambient = Gdx.audio.newMusic(Gdx.files.internal("audio/ambient.ogg"));
